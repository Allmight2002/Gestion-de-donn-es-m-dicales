-- =============================================================================
-- 20260616098200_complete_inspection_accepted_guard.sql
-- Audit v19 §5.2 : la re-creation de complete_file_inspection par la migration
-- 098100 (quarantaine physique) avait PERDU le garde-fou de la 097700 : un
-- verdict `accepted` doit etre refuse par la BASE s'il n'apporte pas hash,
-- taille (> 0) et MIME detecte — meme si l'appelant est service_role et que
-- l'Edge fournit toujours ces valeurs (defense en profondeur : la base ne
-- fait pas confiance a l'appelant pour une fonction de securite centrale).
-- Fonction re-creee A L'IDENTIQUE de la 098100, seul le garde est ajoute.
-- =============================================================================

-- =============================================================================
-- 20260616094000_import_curated_merged_validation.sql  (audit v10 §5.2)
-- A l'import `curated` d'un patient EXISTANT, la completude des champs requis etait verifiee sur le
-- seul FRAGMENT du fichier (v_pdata), pas sur les donnees RESULTANTES (existant fusionne avec le
-- fragment selon le mode de conflit). Importer une ligne curated sans repeter des champs requis
-- DEJA presents sur le patient levait donc une fausse erreur « champ requis ». On valide desormais
-- la completude sur les donnees FUSIONNEES. (La completude de la RENCONTRE reste sur son fragment :
-- une rencontre est toujours NOUVELLE.) Migration ADDITIVE (redefinit import_records).
-- =============================================================================

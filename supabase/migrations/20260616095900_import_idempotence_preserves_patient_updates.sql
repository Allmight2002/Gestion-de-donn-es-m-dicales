-- =============================================================================
-- 20260616095900_import_idempotence_preserves_patient_updates.sql
-- P1 audit: an already imported encounter row must not swallow patient/identity
-- updates present on the same row. The duplicate encounter is skipped, but the
-- patient merge still runs. Structural import dates are also checked strictly
-- before casts.
-- =============================================================================

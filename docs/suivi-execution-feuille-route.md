...
L22 (export), L23 (`has_any`/`has_none` dans `CohortBuilder`), L24 (refus au mappage d'import),
L26 (regroupement de `diagnostic_1/2/3`). Le réordonnancement des étiquettes n'est pas offert : la

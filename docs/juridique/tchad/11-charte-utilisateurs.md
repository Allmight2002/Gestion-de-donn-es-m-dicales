...
| Références | Code de déontologie médicale du Tchad `[référence à confirmer]` ; Code pénal tchadien (loi n° 2017-01 du 8 mai 2017), secret professionnel `[article à préciser]` ; loi n° 007/PR/2015 ; [PSSI (06)](06-politique-securite.md) |
...
- Toute personne accédant à MedData est tenue au **secret professionnel** (Code pénal
  tchadien de 2017 `[article à préciser]` ; déontologie médicale), y compris les
...
médecins le cas échéant ; poursuites civiles et pénales prévues par la loi
n° 007/PR/2015 (amendes, interdictions de traitement, peines d'emprisonnement
`[barème à confirmer]`) et par le Code pénal tchadien (secret professionnel). Les
journaux d'audit font foi.
...
2. m'engage à respecter le **secret professionnel** et la confidentialité de toute
   ...
   de ma mission, conformément au Code pénal tchadien et, le cas échéant, au Code de

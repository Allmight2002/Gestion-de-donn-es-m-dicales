...
| Fondement | Loi n° 007/PR/2015 (droits d'information, d'accès, de rectification, d'effacement et d'opposition ; retrait du consentement) |
...
- La portabilité ne semble pas expressément consacrée par la loi n° 007/PR/2015
  `[à confirmer sur le texte]` ; traiter toute demande de ce type comme un droit
  d'accès au format structuré : fournir les données dans un format lisible par machine
  (CSV/JSON établi à partir du dossier). En pratique rare pour un registre de recherche.
...
possibilité de saisir l'ANSICE, autorité de protection des données du Tchad.

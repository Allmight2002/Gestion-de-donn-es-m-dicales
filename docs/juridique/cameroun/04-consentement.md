...
**Avis éthique : `[référence]` — Autorisation administrative : `[référence]`**
...
### D. Hébergement et transfert des données hors du Cameroun (obligatoire pour participer)
...
- ☐ J'ai compris que mes données seront hébergées de manière sécurisée sur des serveurs
  ...
  transfert**, encadré par la loi camerounaise n° 2024/017.

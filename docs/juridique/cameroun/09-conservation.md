...
| Version | 1.0 (projet) |
| Date | 2026-07-14 |
| Statut | **PROJET — à valider** (comité d'éthique pour les durées de recherche ; conseil juridique ; responsable du traitement) |
| Principe | Aucune conservation indéfinie par défaut ; chaque catégorie a une durée justifiée, un déclencheur et un sort final |

**Note de méthode.** La loi n° 2024/017 pose le principe d'une conservation limitée à la
durée nécessaire aux finalités ; elle ne fixe pas de durées chiffrées par catégorie. Les
durées ci-dessous s'appuient sur les usages de la recherche clinique (conservation
longue des données sources pour vérifiabilité scientifique, généralement 10 à 15 ans)
et doivent être **arrêtées définitivement avec le comité d'éthique et le conseil
juridique**, puis reportées dans la notice d'information (03).

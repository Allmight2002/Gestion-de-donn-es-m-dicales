...
| Fondement | Loi n° 2024/017 (obligation de notification des violations) ; loi n° 2010/012 |
...
1. **À l'autorité de protection des données personnelles** : toute violation
   présentant un risque pour les droits des personnes est notifiée **sans retard
   injustifié** — objectif interne : **72 heures** après la qualification
   `[délai légal exact de la loi n° 2024/017 à confirmer par le conseil juridique ;
   si l'autorité n'est pas encore opérationnelle, consigner la notification préparée
   et l'adresser dès ouverture des guichets — l'horodatage du registre fait foi]`.
   Contenu type : voir modèle §7.

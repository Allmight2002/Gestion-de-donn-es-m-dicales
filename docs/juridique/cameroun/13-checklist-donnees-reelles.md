...
|---|---|---|---|---|
| ☐ | Dossier juridique (docs 00 à 11) complété (plus aucun `[À COMPLÉTER]`) et **validé par un conseil juridique camerounais** (numéros d'articles vérifiés sur les textes officiels) | Avis écrit du conseil | | |
...
| ☐ | **Clairance éthique** obtenue du comité compétent | Original de l'avis (référence reportée dans 03/04) | | |
| ☐ | **Autorisation administrative de recherche** (MINSANTE/DROS) obtenue | Original de l'AAR | | |

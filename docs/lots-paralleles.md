...
| ~~E5~~ | ~~Évolution du formulaire : complétion des patients et rencontres~~ | **implémenté localement le 2026-09-17 ; non déployé** ; preuve navigateur sur banc fictif | sous-lot justification propriétaire encore ouvert ; ne pas rouvrir ces fiches avec un autre lot |

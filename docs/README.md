...
| [spec-collecte-diagnostique.md](spec-collecte-diagnostique.md) | 📋 **Partiellement implémentée, revue le 2026-09-05** — **L55** ([l55-configuration-diagnostique.md](l55-configuration-diagnostique.md)) implémenté et non déployé : diagnostic pilote versionné et couverture ; **L56** (socle enregistrable sans bloc et suivi) reste à faire ; reprise/notifications en cadrage différé L57 |
